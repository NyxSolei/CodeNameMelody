...
public class CutsceneManager : MonoBehaviour
{
    ...
    [SerializeField] Sprite _unlockedDoor;
    ...
    {
        _door.GetComponent<SpriteRenderer>().sprite = _unlockedDoor;
    ...
    public void SetScenesContent()
    {
        ...
        _scenesText[_thirdRecordKey] = new string[] { "This is the song they danced to at their wedding...\nI remember Mom telling me about it with such warmth." };
        _scenesText[_fourthRecordKey] = new string[] { "Dad always played this solo with such passion...\nMom said that in those moments, it was like he became one with his music." };
        _scenesText[_fifthRecordKey] = new string[] { "Mom was so proud of this performance..." ,"I've heard this story a hundred times,\nbut every time I saw the same sense of triumph in her eyes." };
